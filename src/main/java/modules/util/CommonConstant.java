...
public interface CommonConstant {
     ...
     * 系统日志类型： 登录
     */
    public static final int CommonConstantLOG_TYPE_1 = 1;
    ...
    public static final Integer SC_OK_400 = 400;
    ...
    /** 登录用户Token令牌缓存KEY前缀 */
    public static final String PREFIX_USER_ADMIN_TOKEN  = "prefix_user_merchat_token_";
//  /** 登录用户Token令牌缓存KEY前缀 */
//  public static final String PREFIX_USER_ADMIN_TOKEN  = "prefix_user_admin_token_";
    /** Token缓存时间：3600秒即一小时 */
